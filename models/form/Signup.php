...
class Signup extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            ['username', 'required'],
            ['username', 'unique', 'targetClass' => 'jx\admin\models\Master', 'message' => 'This username has already been taken.'],
            ['username', 'string', 'min' => 2, 'max' => 255],

            ['email', 'filter', 'filter' => 'trim'],
            ['email', 'required'],
            ['email', 'email'],
            ['email', 'unique', 'targetClass' => 'jx\admin\models\Master', 'message' => 'This email address has already been taken.'],
