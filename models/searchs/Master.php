...
namespace jx\admin\models\searchs;

use yii\base\Model;
use yii\data\ActiveDataProvider;
use jx\admin\models\Master as MasterModel;

/**
 * Master represents the model behind the search form about `jx\admin\models\Master`.
 */
