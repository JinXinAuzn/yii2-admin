...
namespace jx\admin\components;

use jx\admin\models\Logs;
...
class AdminLog extends Model
{
	...
	public static function afterInsert($event){
		if (!empty($event->changedAttributes) && $event->sender->className() != 'jx\admin\models\Logs') {
	...
	public static function afterDelete($event){
		if ($event->sender->className() != 'jx\admin\models\Logs') {
