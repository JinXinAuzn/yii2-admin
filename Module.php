 ...
 * 'controllerMap' => [
 *     'assignment' => [
 *         'class' => 'jx\admin\controllers\AssignmentController',
...
class Module extends \yii\base\Module
{
	 ...
	 * Its used when `layout` set to 'left-menu', 'right-menu' or 'top-menu'.
	 */
	public $mainLayout = '@jx/admin/views/layouts/main.php';
	/**
	 * 自定义国际化
	 */
	public $i18n = '@jx/admin/messages';
	/**
	 * @var array
	 * @see [[menus]]
	 */
	...
	public function init()
	{
		...
		if (class_exists('yii\jui\JuiAsset')) {
			Yii::$container->set('jx\admin\AutocompleteAsset', 'yii\jui\JuiAsset');
		}
	}
